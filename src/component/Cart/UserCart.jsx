    ...
    return (
        JSON.stringify(cart) !== '{}' ? <div style={{paddingTop: '100px'}}>
            ...
            <div className='d-flex justify-content-between flex-wrap'>
                <div><Button onClick={() => setModalShow(true)} style={{padding: '10px', minWidth: '140px'}}
                             variant='light'>Make an order</Button></div>
                <div><Button onClick={deleteAllProduct} style={{padding: '10px', minWidth: '140px'}} variant='light'>Delete
                    order</Button></div>
                <div><NavLink to='/list'><Button style={{padding: '10px', minWidth: '140px'}} variant='light'>Go to
                    list</Button></NavLink></div>
            </div>
